...
class ResNet(MammothBackbone):
    ...
    def __init__(
        self, block: BasicBlock, num_blocks: List[int], num_classes: int, nf: int
    ) -> None:
        """
...
def resnet18(nclasses: int, num_blocks: List[int] = None, nf: int = 64) -> ResNet:
    """
    ...
    if num_blocks is None:
        num_blocks = [2, 2, 2, 2]
    return ResNet(BasicBlock, num_blocks, nclasses, nf)
