...
class ContinualDataset:
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        assert self.NUM_CLASSES % args.classes_per_task == 0
        self.n_tasks = self.NUM_CLASSES // args.classes_per_task
