...
def get_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Online EWC + Labels Trick")
...
class EwcLT(ContinualModel):
    NAME = "ewc_lt"

    def __init__(self, backbone, loss, dataset_config, args, transform):
        super(EwcLT, self).__init__(backbone, loss, dataset_config, args, transform)
